...
<form method="post" action="viewrewardscontroller.php">
    <fieldset>
       <legend> View Customer Rewards </legend>
<label id="label" for="CustomerId"> Customer Id </label> </br>
<input type="number" name="CustomerId" placeholder=" Enter your Id here" > </br>
